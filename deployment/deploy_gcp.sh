...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --port 8501 \
  --set-env-vars "OPENAI_API_KEY=${OPENAI_API_KEY:-},ANTHROPIC_API_KEY=${ANTHROPIC_API_KEY:-},GROQ_API_KEY=${GROQ_API_KEY:-},OTEL_EXPORTER_OTLP_ENDPOINT=${OTEL_EXPORTER_OTLP_ENDPOINT:-}"
