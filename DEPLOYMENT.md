...
| Variable | Purpose |
| --- | --- |
| `OPENAI_API_KEY` | Enables live OpenAI (`gpt-4o-mini`) neural parsing |
| `ANTHROPIC_API_KEY` | Enables live Anthropic (`claude-3-5-sonnet`) neural parsing (used if OpenAI key absent) |
